...
(function() {
  ...
  btn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="#007B5E"/><text x="12" y="16" text-anchor="middle" fill="white" font-size="16" font-family="Arial" dy=".3em">?</text></svg>';
  ...
  popup.innerHTML = '<select id="langSelect" style="width:100%;margin-bottom:10px"><option value="ru">Рус</option><option value="kz">Қаз</option><option value="en">Eng</option></select><div id="faqList">Загрузка...</div><input id="faqInput" type="text" placeholder="Ваш вопрос..." style="width:100%;padding:8px;border:1px solid #ccc;border-radius:6px;margin-top:10px"/><a id="faqSend" href="#" target="_blank" style="margin-top:10px;display:inline-block;background:#007B5E;color:white;padding:10px;width:100%;text-align:center;border-radius:6px;text-decoration:none">Отправить вопрос</a>';
